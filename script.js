...
function popupOpenCloseHandler() {
  shaddow.classList.toggle('states__action_hidden');
  editPopup.classList.toggle('states__action_hidden');
  pageBody.classList.toggle('states__action_overflow-hidden');
